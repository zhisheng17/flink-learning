 ...
 */
public class KubernetesConfigMapWatcher extends AbstractKubernetesWatcher<ConfigMap, KubernetesConfigMap> {
	...
	public void eventReceived(Action action, ConfigMap configMap) {
		...
		final List<KubernetesConfigMap> configMaps = Collections.singletonList(new KubernetesConfigMap(configMap));
		switch (action) {
			case ADDED:
