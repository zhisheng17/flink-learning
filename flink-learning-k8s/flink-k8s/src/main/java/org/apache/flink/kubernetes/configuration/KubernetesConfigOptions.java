		...
		key("kubernetes.hostnetwork.enabled")
			...
			.withDescription(
				"Whether to enable HostNetwork mode. "
					+ "The HostNetwork allows the pod could use the node network namespace instead "
					+ "of the individual pod network namespace. Please note that the JobManager "
					+ "service account should have the permission to update Kubernetes service.");
