...
public class Constants {
	...
	public static final String HIVE_CONF_VOLUME = "hive-config-volume";
	public static final String HIVE_CONF_CONFIG_MAP_PREFIX = "hive-config-";
	public static final String HIVE_CONF_DIR_IN_POD = "/app/hive/conf";
	public static final String ENV_HIVE_CONF_DIR = "HIVE_CONF_DIR";
	public static final String ENV_HIVE_HOME = "HIVE_HOME";
